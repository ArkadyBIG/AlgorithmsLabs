...
class SplayTree {
 private:
  ...
  void print_this(SplayNode *temp) {
    if (temp->leftChild) {
      std::cout << temp->key << ":" << temp->data.hours << " -> " << temp->leftChild->key << ":"
                << temp->leftChild->data.hours << std::endl;
      print_this(temp->leftChild);
    }
    if (temp->rightChild) {
      std::cout << temp->key << ":" << temp->data.hours << " -> " << temp->rightChild->key << ":"
                << temp->rightChild->data.hours << std::endl;
